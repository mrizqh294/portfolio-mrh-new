...
const Contact = () => {
  ...
  const SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbwp5-hR92dYvjxNzDr62ofwGEZjdocEb9pRwfWw-72CVQ_wG36ROVDtlEV2SXlkefEFww/exec";
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="mt-3 text-zinc-500 dark:text-zinc-400 text-sm md:text-base max-w-md mx-auto">
            Punya proyek atau ide kolaborasi? Silakan hubungi saya lewat salah
            satu kontak di bawah, atau kirim pesan langsung lewat form.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="w-full border border-gray-200 cursor-pointer bg-gray-900 dark:bg-gray-800 text-white hover:text-gray-900 text-sm font-medium py-3 rounded-lg
