        ...
        >
          <div>
            ...
            <motion.div className="mt-3" variants={itemVariants}>
              <RotatingText
                texts={["Web Developer", "Backend Developer", "System Analyst"]}
                mainClassName="px-2 sm:px-2 md:px-3 text-2xl lg:text-3xl bg-transparent font-semibold text-gray-900 dark:text-white overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                staggerFrom="last"
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "-120%" }}
